...
impl ConcreteObject for ZwpIdleInhibitManagerV1 {
    const XML_VERSION: u32 = 1;
    const INTERFACE: ObjectInterface = ObjectInterface::ZwpIdleInhibitManagerV1;
    const INTERFACE_NAME: &str = "zwp_idle_inhibit_manager_v1";
}
